...
;// CONCATENATED MODULE: ./node_modules/@trim21/gm-fetch/dist/esm/index.js
...
function gmXHRMethod(method) {
    if (method === "GET" || method === "POST" || method === "PUT" || method === "DELETE" || method === "PATCH" || method === "HEAD" || method === "TRACE" || method === "OPTIONS" || method === "CONNECT") {
        return method;
    }
